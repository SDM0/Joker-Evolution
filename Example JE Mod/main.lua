--- STEAMODDED HEADER
--- MOD_NAME: Example JE Mod
--- MOD_ID: exmaple_je_mod
--- MOD_AUTHOR: [SDM_0]
--- MOD_DESCRIPTION: Example mod of the Joker Evolution API
--- BADGE_COLOUR: 446934
--- DISPLAY_NAME: Example JE Mod
--- PREFIX: exmpl
--- VERSION: 1.0.0
...
if SMODS.Mods['joker_evolution'] then
    ...
    JokerEvolution.evolutions:add_evolution("j_joker", "j_exmpl_ultimate_joker", 1)
